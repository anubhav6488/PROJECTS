...
const app = express();
const authController = require('./controllers/onboarding');
...
// app.use(passport.session()); // Enable session support if needed

// Routes for Google OAuth authentication
// app.get('/auth/google', authController.authenticateGoogle);
